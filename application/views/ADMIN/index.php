            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <?php if (isset($_SESSION['ADMIN'])) {?>
                  <?php echo imgProfil($_SESSION['ADMIN']['profil'], 'user-image','user-image','user-image'); ?>
                <?php } else{ ?>
                ...
                <?php if (isset($_SESSION['ADMIN'])) {?>
                  ...
                  <span class="hidden-xs"><?php echo $_SESSION['ADMIN']['prenom'] ?></span>
                <?php }else{ ?>
                      <span>
              ...
              <ul class="dropdown-menu">
                ...
                <?php if (isset($_SESSION['ADMIN'])) {?>                  
                    <p>
                      ...
                      <?php echo $_SESSION['ADMIN']['prenom']?>
                    </p>
                <?php } ?>
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <?php if (isset($_SESSION['ADMIN'])) {?>
                      <a href="<?php echo site_url(array('Administration','voirprofil')) ?>" class="btn btn-default btn-flat">Profil</a>
                    <?php } ?>
                  </div>
