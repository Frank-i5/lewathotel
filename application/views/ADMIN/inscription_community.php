	...
	<body class="templatemo-bg-image-1">
		<div class="container">
			...
			<div class="row" style="margin-top:130px;">
				<form action="<?php echo site_url(array('Administration','AddCommunity')) ?>" method="post" enctype="multipart/form-data">

					<div class="row">
						<div class="col-md-12">
							<h1 class="h" style="text-align:center; color:#BD655B;">INSCRIVEZ UN COMMUNITY MANAGER <input type = "button" value = "x" onclick = "history.go(-1)" style="background-color:red; color:white; font-size:20px;"> </h1><br><br>
					...
					<div class="col-md-6">
				        ...
				        <div class="input-group has-feedback">
				        	<span Class="input-group-addon essai"><span class="glyphicon glyphicon-user"></span></span>
				         	<input  class="form-control inputt validity " type="text" name="nom" id="Nom" id="name" required="" placeholder="Votre Nom" minlength="4" pattern="[a-zA-ZàâæçéèêëîïôœùûüÿÀÂÆÇnÉÈÊËÎÏÔŒÙÛÜŸ-]++{3,20}" maxlength="50" title=" saisir votre nom sans caractere special">
	              			<span class="validity input-group-addon" style="background-color: none;"></span>
				        </div>

				        <label for="prenom"></sup>Prenoms</label>
				        <div class="input-group has-feedback">  
				          <span Class="input-group-addon essai"><span class="glyphicon glyphicon-user"></span></span>
				          <input id="name"  class="form-control inputt validity " type="text" name="prenom" id="Prenom" required="" placeholder="Votre Prenom" minlength="4" pattern="[a-zA-ZàâæçéèêëîïôœùûüÿÀÂÆÇnÉÈÊËÎÏÔŒÙÛÜŸ-]++{3,20}" maxlength="50" title=" saisir votre nom sans caractere special">
	              			<span class="validity input-group-addon" style="background-color: none;"></span>  
				        </div>
				        ...
				        <div class="input-group has-feedback">  
				          ...
				          <input id="name"  class="form-control inputt validity" type="email" name="email" id="email" required="" placeholder="Example@example.com" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$">
	              			<span class="validity input-group-addon" style="background-color: none;"></span>  
				        </div>
				        ...
				        <div class="input-group has-feedback">
							...
							<input id="name" class="form-control inputt" type="password" name="password" id="Pswd" required="" minlength="5" title="Entrer un mot de passe d'au moins 5 caracteres">
	              			<span class="validity input-group-addon" style="background-color: none;"></span>  
				        </div>
				    ...
				    <div class="col-md-6">
				    	...
				    	<div class="input-group has-feedback">
							...
							<input id="name"  class="form-control inputt validity " type="text" name="telephone" id="telephone" required="" placeholder="Votre Numéro de Téléphone" minlength="4" pattern="[0-9]+" maxlength="50" title=" saisir votre Numéro de Téléphone sans caractere special">
	              			<span class="validity input-group-addon" style="background-color: none;"></span>  
				        </div>
				        <p class="alert alert-danger Erreur" style="color:red;"> Veillez Remplir le champ ci dessus </p>
						...
						<div class="col-md-offset-5 col-md-3">
							...
							<input class="form-control inpt4" type="hidden" name="niveau" value="2">
