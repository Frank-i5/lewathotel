		...
		<div class="row" style="margin-top:150px;">
				...
				<div class="col-md-offset-5 col-md-4 col-sm-offset-2 col-sm-8 col-xs-offset-2 col-xs-8" style="text-align:center; color:white;" >
					...
					<section class="content-header">
						...
						<nav style="margin-top:20px;">
	    					<?php if (isset($_SESSION['ADMIN'])) {?>
					            ...
					            <?php } else{ ?>
					            <?php echo imgProfil($_SESSION['Community']['profil'], 'user-image cl','user-image','user-image'); ?>
					            <?php }  ?>
	    				</nav>

	    				<nav style="margin-top:20px;">
	    				<?php if (isset($_SESSION['ADMIN'])) {?>
					    <label for="nom">Nom :<?php echo $_SESSION['ADMIN']['nom']?></label><br>
					    <label for="prenom">Email :<?php echo $_SESSION['ADMIN']['prenom'] ?></label><br>
					    <label for="email">Email :<?php echo $_SESSION['ADMIN']['email'] ?></label><br>
					    <label for="password">Password :<?php echo $_SESSION['ADMIN']['password'] ?></label><br>
				    ...
				    <section class="content chat-popup" id="myForm" style="margin-top:50px;">
		                ...
		                <form class="form-horizontal templatemo-contact-form-1" role="form" action="<?php if(isset($_SESSION['ADMIN'])) { echo site_url(array('Administration','modifierprofil')); }?>" enctype="multipart/form-data" method="post">
			        		...
			        		<div class="form-group">
			          			<div class="col-md-12">
			                		...
			                		<input id="nom" class="form-control" type="text" name="newnom" value="<?php if (isset($_SESSION['ADMIN'])){echo $_SESSION['ADMIN']['nom'];}?>" required>
			            			</div>		            		            		            
			         			 </div>              
			        		</div>
			        		<div class="form-group">
			          			<div class="col-md-12">
			                		...
			                		<input id="prenom" class="form-control" type="text" value="<?php if (isset($_SESSION['ADMIN'])){echo $_SESSION['ADMIN']['prenom'];}?>" class="form-control" name="newprenom">
			            			</div>
			         			 </div>
			        		</div>
			        		<div class="form-group">
			          			<div class="col-md-12">
			                		...
			                		<input id="email" class="form-control" type="text" type="email" value="<?php if (isset($_SESSION['ADMIN'])){echo $_SESSION['ADMIN']['email'];}?>" class="form-control" name="newemail">
			            			</div>
			          			</div>
			        		</div>
			        		<div class="form-group">
			          			<div class="col-md-12">
			                		...
			                		<input id="pass" class="form-control" type="password" name="password" value="<?php echo $_SESSION['ADMIN']['password'] ?>">
			            			</div>
			          			</div>
			        		</div>
			        		<div class="form-group">
			          			<div class="col-md-12">
			                		...
			                		<input id="pass" class="form-control" type="password" value="<?php if (isset($_SESSION['ADMIN'])){echo $_SESSION['ADMIN']['password'];}?>" class="form-control" name="newpassword">
			            			</div>
			          			</div>
			        		</div>
			        		<div class="form-group">
			        		...
			        		<div class="col-md-offset-3 col-md-4 im">
			            		<img style="width:200px; height:200px;" id="im" src="<?php if (isset($_SESSION['ADMIN'])){echo imgProfil_url($_SESSION['ADMIN']['profil']);}?>"/>
			        		</div>
			       			<div class="form-group">
			          			<div class="col-md-12"><br> <br>
                      				<input type="hidden" value="<?php echo $_SESSION['ADMIN']['id'] ?>" name="id">
	        						...
	        						<a href="<?php if(isset($_SESSION['ADMIN'])) { echo site_url(array('Administration','formmodifierprofil')); }?>"></a>
			          			</div>
			        		</div>		    	
			    		</form>
	                </section>
