      ...
      <div class="row">
        <div class="col-md-offset-4 col-md-5" >
          <div class="box box-primary">
            <form role="form" enctype="multipart/form-data"action="<?php if(isset($_SESSION['ADMIN'])){echo site_url(array('Administration','addProduit'));}else{ echo site_url(array('Community_Manager','addProduit'));} ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="numero_produit" class="form-control" id="local-upload"  placeholder="Veuillez entrer le Numéro du Produit"></input>  
                </div>
                <div class="form-group">
                  <label >Description du produit</label>
                  <textarea type="text" name="description" rows="" class="form-control" id="local-upload"  placeholder="Veuillez entrer la Description du Produit"></textarea>  
                </div>
                <div class="form-group">
                  <label >Prix du Produit</label>
                  <input type="text" name="prix" class="form-control" id="local-upload"  placeholder="Veuillez entrer le prix du Produit"></input>  
                </div>
